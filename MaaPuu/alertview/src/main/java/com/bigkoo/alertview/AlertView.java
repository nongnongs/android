...
//            tvAlert.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        boolean bool;
        if((title == null || title.equals("")) && (msg == null || msg.equals(""))){
            bool = true;
        }else {
            bool = false;
        }
        AlertViewAdapter adapter = new AlertViewAdapter(mDatas,mDestructive,bool);
...
//                    tvAlert.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    public AlertView setCanDismiss(boolean bool){
