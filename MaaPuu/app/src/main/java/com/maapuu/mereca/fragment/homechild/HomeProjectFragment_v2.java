...
public class HomeProjectFragment_v2 extends BaseFragment implements LeftCallBack{
    ...
    protected int setContentViewById() {
        ...
        return R.layout.fragment_home_project_v2;
    }
    ...
    protected void initData() {
        mHttpModeBase.xPost(HttpModeBase.HTTP_REQUESTCODE_1, UrlUtils.project_list_new_get(LoginUtil.getInfo("token"),LoginUtil.getInfo("uid"),shop_id,0),true);
    }
