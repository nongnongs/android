...
public class BindPhoneActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        thirdLoginBean = (ThirdLoginBean) getIntent().getSerializableExtra("thirdLoginBean");
    }
    ...
    @Override
    @OnClick({R.id.txt_left,R.id.txt_code,R.id.txt_bind})
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.txt_code:
                ...
                mHttpModeBase.xPost(HttpModeBase.HTTP_REQUESTCODE_2, UrlUtils.cmm_sms_code_get(etPhone.getText().toString(),"4"),true);
                break;
            case R.id.txt_bind:
                if(StringUtils.isEmpty(etPhone.getText().toString())){
    ...
    private void thirdLogin() {
        mHttpModeBase.xPost(HttpModeBase.HTTP_REQUESTCODE_3, UrlUtils.user_third_login_get(thirdLoginBean.getLogin_type(),thirdLoginBean.getThird_userid()
                ,thirdLoginBean.getNick_name(),thirdLoginBean.getAvatar(),thirdLoginBean.getSex(), thirdLoginBean.getDevice_tokens(),
                etPhone.getText().toString(),sms_id,etCode.getText().toString()),true);
    }
