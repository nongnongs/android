...
import com.maapuu.mereca.activity.ProjectListActivity;
...
public class HomeProjectFragment extends BaseFragment {
    ...
    protected void initData() {
        mHttpModeBase.xPost(HttpModeBase.HTTP_REQUESTCODE_1, UrlUtils.shop_catalog_get(LoginUtil.getInfo("token"),LoginUtil.getInfo("uid"),shop_id,"1"),true);
    }
    ...
    private void setAdapter() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                it = new Intent(mContext, ProjectListActivity.class);
