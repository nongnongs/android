...
public class PayPsdInputView extends android.support.v7.widget.AppCompatEditText {
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        txtSize = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_txtSize, sp2px(txtSize));
        isPassword = typedArray.getBoolean(R.styleable.PayPsdInputView_isPassword, isPassword);
        ...
        backgroundColor = typedArray.getColor(R.styleable.PayPsdInputView_backColor, backgroundColor);
...
//                drawItemFocused(canvas, position);
    ...
    private void drawWeChatBorder(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF.left+divideLineWidth/2,rectF.top+divideLineWidth/2,rectF.right-divideLineWidth/2,rectF.bottom-divideLineWidth/2,
                rectAngle, rectAngle, borderPaint);
    ...
    private void drawPsdText(Canvas canvas) {
        ...
        for (int i = 0; i < textLength; i++) {
            canvas.drawText(getPasswordString().substring(i,i+1),startX + i * 2 * startX - 10,
                    startY,
                    mTextPaint);
        }
    }
    ...
    protected void onTextChanged(CharSequence text, int start, int lengthBefore, int lengthAfter) {
        ...
        if (textLength == maxCount) {
            ...
            mListener.inputUnFinished(getPasswordString());
        }
    ...
    public interface onPasswordListener {
        ...
        void inputUnFinished(String inputPsd);
    }
}
