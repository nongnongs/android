...
public class ExpandableView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMaxCollapsedLines = typedArray.getInt(R.styleable.ExpandableView_maxTextLines, MAX_COLLAPSED_LINES);
        mAnimationDuration = typedArray.getInt(R.styleable.ExpandableView_animDur, DEFAULT_ANIM_DURATION);
