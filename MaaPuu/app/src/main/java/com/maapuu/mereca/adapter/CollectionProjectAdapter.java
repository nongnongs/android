...
public class CollectionProjectAdapter extends RecyclerView.Adapter<CollectionProjectAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public CollectionProjectAdapter(Context context, List<ProjectBean> list){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_collection_project_item,parent,false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.txtProjectName.setText(list.get(position).getItem_name());
        holder.txtProjectDesc.setText(list.get(position).getItem_desc());
