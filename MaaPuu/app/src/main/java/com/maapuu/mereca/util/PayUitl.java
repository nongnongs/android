...
import com.maapuu.mereca.util.alipay.SignUtils;
...
public class PayUitl {
     ...
     */
    public static String getOrderInfo(String partner,String seller_id,String subject,String body,String out_trade_no, String notify_url, String price) {
