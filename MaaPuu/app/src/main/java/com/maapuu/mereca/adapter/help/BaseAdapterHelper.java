 ...
 */
package com.maapuu.mereca.adapter.help;
...
public class BaseAdapterHelper {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setColerText(int viewId, Spanned value) {
        TextView view = retrieveView(viewId);
        view.setText(value);
        return this;
    }
     ...
     * Will set the text of a TextView.
     * @param viewId The view id.
     * @param value  The text to selected in the text view.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setSelectedTv(int viewId, boolean value) {
        TextView view = retrieveView(viewId);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setSelectedLy(int viewId, boolean value) {
        LinearLayout view = retrieveView(viewId);
        view.setSelected(value);
        return this;
    }
     ...
     * @param viewId   The view id.
     * @param childView The child.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper AddViewLy(int viewId, View childView) {
        LinearLayout view = retrieveView(viewId);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper reMoveViewLy(int viewId, View childView) {
        LinearLayout view = retrieveView(viewId);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper reMoveAllViewLy(int viewId) {
        LinearLayout view = retrieveView(viewId);
        view.removeAllViews();
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper AddViewRl(int viewId, View childView) {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper reMoveViewRl(int viewId, View childView) {
        RelativeLayout view = retrieveView(viewId);
        view.removeView(childView);
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper reMoveAllViewRl(int viewId) {
        RelativeLayout view = retrieveView(viewId);
        view.removeAllViews();
        return this;
    }

    public BaseAdapterHelper setParams(int viewId, ViewGroup.LayoutParams lp) {
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setEnabled(int viewId, boolean value) {
        View view = retrieveView(viewId);
     ...
     * Will set the text of a TextView.
     * @param viewId The view id.
     * @param params  The params to ViewGroup.LayoutParams in the view.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setLayoutParams(int viewId,ViewGroup.LayoutParams params) {
        View view = retrieveView(viewId);
    ...
    public BaseAdapterHelper setTextFlags(int viewId, int flags) {
     ...
     * @param viewId   The view id.
     * @param imageUrl The image URL.
     * @param failImageId The onfail image ID.
     * @return The BaseAdapterHelper for chaining.
     */
//    public BaseAdapterHelper setSRoundedViewImageUrl(int viewId,String imageUrl,int failImageId) {
//        SelectableRoundedImageView view = retrieveView(viewId);
//        if (!StringUtils.isEmpty(imageUrl))
//            Picasso.with(context).load(imageUrl).placeholder(failImageId).error(failImageId).config(Bitmap.Config.RGB_565).resize(dp2px(250),dp2px(250))
//                    .centerCrop().into(view);
//        else
//            view.setImageResource(failImageId);
...
//    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setSimpViewImageUri(int viewId, Uri imageUri) {
     ...
     * If you need more control over the Picasso settings, use {BaseAdapterHelper#setImageBuilder}.
     * @param viewId   The view id.
     * @param value  The AspectRatio value.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setSimpViewAspectRatio(int viewId, float value) {
        SimpleDraweeView view = retrieveView(viewId);
     ...
     * Set a view visibility to VISIBLE (true) or GONE (false).
     * @param viewId  The view id.
     * @param value True for VISIBLE, false for GONE.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setVisible(int viewId, int value) {
        View view = retrieveView(viewId);
     ...
     * Set a view visibility to VISIBLE (true) or GONE (false).
     * @param viewId  The view id.
     * @param left value for view PaddingLet
     * @param top value for view PaddingTop
     * @param right value for view PaddingRight
     * @param bottom value for view PaddingBottom
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setPadding(int viewId,int left,int top,int right,int bottom) {
        View view = retrieveView(viewId);
     ...
     * Set a view visibility to VISIBLE (true) or GONE (false).
     * @param viewId  The view id.
     * @param left value for view MarginLeft
     * @param top value for view MarginTop
     * @param right value for view MarginRight
     * @param bottom value for view MarginBottom
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setMargins(int viewId,int left, int top, int right, int bottom) {
        View view = retrieveView(viewId);
    ...
    public BaseAdapterHelper setMargins(int viewId,Context mContext,int left, int top, int right, int bottom) {
        View view = retrieveView(viewId);
        if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
            ViewGroup.MarginLayoutParams p = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
