...
import com.maapuu.mereca.adapter.AttectionShopAdapter;
...
public class AttectionShopFragment extends BaseFragment {
    ...
    private AttectionShopAdapter adapter;
    ...
    private void initData(int pageNum) {
        mHttpModeBase.xPost(HttpModeBase.HTTP_REQUESTCODE_1, UrlUtils.attention_list_get(LoginUtil.getInfo("token"),LoginUtil.getInfo("uid"),"1",pageNum),true);
    }
    ...
    private void setAdapter(List<ShopBean> lsJson) {
        ...
        list.addAll(lsJson);
        if(adapter == null){
            adapter = new AttectionShopAdapter(mContext,list);
        ...
        adapter.setOnItemClickListener(new AttectionShopAdapter.OnRecyclerViewItemClickListener() {
            @Override
            ...
            public void onRightItemClick(View v, int position) {
                ...
                mHttpModeBase.xPost(HttpModeBase.HTTP_REQUESTCODE_2,UrlUtils.attention_set(LoginUtil.getInfo("token"),LoginUtil.getInfo("uid"),"1",
                        list.get(position).getShop_id(), "0"),true);
            }
        });
    }
