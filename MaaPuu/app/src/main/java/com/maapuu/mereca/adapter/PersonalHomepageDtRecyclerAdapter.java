...
public class PersonalHomepageDtRecyclerAdapter extends RecyclerView.Adapter<PersonalHomepageDtRecyclerAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    public PersonalHomepageDtRecyclerAdapter(Context context, List<MoBean> list){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_personal_homepage_dt_item,parent,false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        holder.txtDay.setText(list.get(position).getMonth_text().split(" ")[1]);
        holder.txtMonth.setText(list.get(position).getMonth_text().split(" ")[0]);
...
//                            inputMgr.toggleSoftInput(InputMethodManager.HIDE_NOT_ALWAYS, 0);
                            StringUtils.closeKeyBorder(mContext,holder.txtDay);
                            replyDialog.dismiss();
                        }
                    });
                    replyDialog.setOnBtnCommitClickListener(new View.OnClickListener() {
