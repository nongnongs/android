...
public class GoodsCommentRecyclerAdapter1 extends RecyclerView.Adapter<GoodsCommentRecyclerAdapter1.MyViewHolder> implements View.OnClickListener {
    ...
    public static interface OnRecyclerViewItemClickListener {
        ...
        void onDelReplyClick(int position);
    ...
    public GoodsCommentRecyclerAdapter1(Context context, List<EvlBean> list, boolean hasReplayBtn){
...
//                        inputMgr.toggleSoftInput(InputMethodManager.HIDE_NOT_ALWAYS, 0);
        ...
        holder.txtReplyContent.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onDelReplyClick(position);
                }
                return false;
            }
        });
